...
<body>
  ...
  <main>
    ...
    <div class="add">
      <form action="/new/admin/view/program/create_program.php" method="POST" name="form">
        ...
        <textarea name="program_description" id="program_description" rows="7" required></textarea>

        <label for="program_vision">Program Vision</label>
        <textarea name="program_vision" id="program_vision" rows="3" required></textarea>

        <label for="program_mission">Program Mission</label>
        <textarea name="program_mission" id="program_mission" rows="7" required></textarea>
