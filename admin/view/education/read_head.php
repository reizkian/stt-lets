...
while ($row = $result->fetch_assoc()) {
    ...
    echo "<form action='./update_image.php?file_name=s1.png' method='POST' enctype='multipart/form-data'>";
    echo "Select image to upload (recomended size: 304x223 px)";
    ...
    echo "<form action='./update_image.php?file_name=s2.png' method='POST' enctype='multipart/form-data'>";
    echo "Select image to upload (recomended size: 304x223 px)";
    ...
    echo "<form action='./update_image.php?file_name=s3.png' method='POST' enctype='multipart/form-data'>";
    echo "Select image to upload (recomended size: 304x223 px)";
